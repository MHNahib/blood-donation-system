 ...
 * @author com
 */
public class donerSignupAfter extends javax.swing.JFrame {

    /**
     * Creates new form donerSignup
     */
    public donerSignupAfter() {
        initComponents();
    }
    ...
    private void signupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signupActionPerformed
        ...
        /*if(Integer.parseInt(age.getText())<18 || Double.parseDouble(w.getText())<45){
            if(Integer.parseInt(age.getText())<18){
                JOptionPane.showMessageDialog(null, "You are below 18.");
            }
            else{
                JOptionPane.showMessageDialog(null, "You are under weinght.");
            }               
         ...
         if(Integer.parseInt(age.getText())<18 && Double.parseDouble(w.getText())<45){
                ...
                JOptionPane.showMessageDialog(null, "You can't donate blood.");
       ...
       String quary = "INSERT INTO `doner`(`name`, `password`, `email`, `phone`, `blood`, `age`, `weight`, `sex`, `District`) VALUES (?,?,?,?,?,?,?,?,?)";
        ...
        try {
            ...
            Logger.getLogger(donerSignupAfter.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        // TODO add your handling code here:
        donerDetails in = new donerDetails();
        in.main(null);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(donerSignupAfter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new donerSignupAfter().setVisible(true);
            }
        });
    }
